...
public class BrowserContants {
	...
	public static final String PRD_API_URL = "https://commonrehlat.azurewebsites.net/v1/jazeera";
	public static final String STG_API_URL = "https://stagerehlatcommonapi.rehlat.com/v1/jazeera";
